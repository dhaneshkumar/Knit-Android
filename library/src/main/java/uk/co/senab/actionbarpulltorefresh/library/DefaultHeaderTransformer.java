...
*/
    ...
    protected int getActionBarSize(Context context) {
       /* int[] attrs = {android.R.attr.actionBarSize};
        ...
        if (context.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv1, true))
        {
            actionBarHeight = TypedValue.complexToDimensionPixelSize(tv1.data,context.getResources().getDisplayMetrics());
        }
